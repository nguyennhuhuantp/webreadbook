                        ...
                        <div class="modal-content">
                            <form action="editAccount" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="authorization" class="form-select">
                                        <option value="1" ${tag1 == 1 ? "selected" : ""}>Seller</option>
                                        <option value="0" ${tag1 == 0 ? "selected" : ""}>Buyer</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label>Status</label>
                                    <select name="status" class="form-select">
                                        <option value="1" ${tag2 == 1 ? "selected" : ""}>Allow</option>
                                        <option value="0" ${tag2 == 0 ? "selected" : ""}>Block</option>
                                    </select>
                                </div>
                            </div>
