                    ...
                    <div class="card-body">
                        ...
                        <form action="changePass" method="post">
                            ...
                            <div class="input-group form-group">
                                ...
                                <input type="password" name="renewpass" class="form-control" placeholder="Re-password" required>
                            </div>
                            <div class="form-group">
                                <input type="submit" value="Change Password" class="btn float-right changepass_btn">
                            </div>
                        </form>
                    </div>
